...
namespace GamepadInput
{
    ...
    public static class GamePad
    {
        ...
        public enum Button { A, B, Y, X, RightShoulder1, LeftShoulder1, RightShoulder2, LeftShoulder2, RightStick, LeftStick, Select, Start }
            ...
            switch (controlIndex)
            {
                case Index.One:
                    switch (button)
                    {
                        ...
                        case Button.LeftShoulder1: return KeyCode.Joystick1Button6;
                        case Button.RightShoulder1: return KeyCode.Joystick1Button7;
                        case Button.LeftShoulder2: return KeyCode.Joystick1Button4;
                        case Button.RightShoulder2: return KeyCode.Joystick1Button5;
                        case Button.Select: return KeyCode.Joystick1Button9;
                        case Button.Start: return KeyCode.Joystick1Button8;
                ...
                case Index.Two:
                    switch (button)
                    {
                        ...
                        case Button.LeftShoulder1: return KeyCode.Joystick2Button6;
                        case Button.RightShoulder1: return KeyCode.Joystick2Button7;
                        case Button.LeftShoulder2: return KeyCode.Joystick2Button4;
                        case Button.RightShoulder2: return KeyCode.Joystick2Button5;
                        case Button.Select: return KeyCode.Joystick2Button9;
                        case Button.Start: return KeyCode.Joystick2Button8;
                ...
                case Index.Three:
                    switch (button)
                    {
                        ...
                        case Button.LeftShoulder1: return KeyCode.Joystick3Button6;
                        case Button.RightShoulder1: return KeyCode.Joystick3Button7;
                        case Button.LeftShoulder2: return KeyCode.Joystick3Button4;
                        case Button.RightShoulder2: return KeyCode.Joystick3Button5;
                        case Button.Select: return KeyCode.Joystick3Button9;
                        case Button.Start: return KeyCode.Joystick3Button8;
                ...
                case Index.Four:
                    ...
                    switch (button)
                    {
                        ...
                        case Button.LeftShoulder1: return KeyCode.Joystick4Button6;
                        case Button.RightShoulder1: return KeyCode.Joystick4Button7;
                        case Button.LeftShoulder2: return KeyCode.Joystick4Button4;
                        case Button.RightShoulder2: return KeyCode.Joystick4Button5;
                        case Button.Select: return KeyCode.Joystick4Button9;
                        case Button.Start: return KeyCode.Joystick4Button8;
                ...
                case Index.Any:
                    switch (button)
                    {
                        ...
                        case Button.LeftShoulder1: return KeyCode.JoystickButton6;
                        case Button.RightShoulder1: return KeyCode.JoystickButton7;
                        case Button.LeftShoulder2: return KeyCode.JoystickButton4;
                        case Button.RightShoulder2: return KeyCode.JoystickButton5;
                        case Button.Select: return KeyCode.JoystickButton9;
                        case Button.Start: return KeyCode.JoystickButton8;
